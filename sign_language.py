        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                if features is not None:
                    ...
                    elif current_sign.lower() == 'del' or current_sign.lower() == 'delete':
...
# Add other routes and functions from web_app.py here
# Make sure to update the route decorators to use the blueprint
# For example: @sign_language_bp.route('/process_frame', methods=['POST']) 